...
public class SeeGalleryJFrameController 
	...
	public void actionPerformed(ActionEvent ae) {
		System.out.println("Inside SeeGalleryJFrameController:action performed");
	...
	private void cancel_actionPerformed(ActionEvent ae) {
		System.out.println("Customer don't want to see the Gallery anymore!");
		seeGalleryJFrame.setVisible(false);
		seeGalleryJFrame.dispose();
	}

	private void okay_actionPerformed(ActionEvent ae) {
		System.out.println("Customer wants to see the Gallery of the room!");
